...
//        System.out.println("StringList 생성자 끌려옴");
    ...
    // 자료 유무 확인 (includes)
    public boolean includes(Z target) {
    ...
    // 중간 삭제 (remove) : 값으로 삭제
    public Z remove(Z target) {
        return remove(indexOf(target));
    }

    // 중간 삽입 (insert)
    public void insert(int index, Z newData) {
